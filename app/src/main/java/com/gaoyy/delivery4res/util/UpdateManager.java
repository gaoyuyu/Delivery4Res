...
public class UpdateManager
{
    ...
    private Thread downloadApkThread = new downloadApkThread();
    ...
    private Handler mHandler = new Handler()
    {
        public void handleMessage(Message msg)
        {
            switch (msg.what)
            {
                ...
                case DOWNLOAD:
                    // 设置进度条位置
                    Log.d(Constant.TAG, "progress==>" + progress);
    ...
    public void checkUpdate()
    {
        ...
        {
            Toast.makeText(mContext, "无须更新", Toast.LENGTH_LONG).show();
        }
    }
...
//        }
    ...
    public void showNoticeDialog()
    {
        ...
        builder.setTitle(R.string.dialog_check_update);
...
//        });
    ...
    public void showDownloadDialog()
    {
        // 构造软件下载对话框
        AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
        builder.setTitle(R.string.dialog_updateing);
        builder.setCancelable(false);
        // 给下载对话框增加进度条
...
//        });
        ...
        public void run()
        {
            try
            {
                ...
                if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
                {
                    ...
                    Log.d(Constant.TAG,"apk sd path-->"+mSavePath);
                ...
                {
                    CommonUtils.showToast(mContext,"检测无SD卡");
                }
            }
    ...
    private void installApk()
    {
        ...
        Log.d(Constant.TAG,"apkfile-->"+apkfile.toString());
